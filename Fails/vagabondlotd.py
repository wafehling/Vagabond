...
                if num_rooms == 0:
                        player.x = new_x+cameratopx
                        player.y = new_y+cameratopy
                else:
...
def camera_chase():
	...
	if cameratopx + dx >= 0 and cameratopy + dy >= 0 and camerabottomx + dx < MAP_WIDTH and camerabottomy + dy < MAP_HEIGHT:
...
        global cameratopx, cameratopy, SCREEN_WIDTH, SCREEN_HEIGHT
...
        libtcod.console_blit(con, cameratopx, cameratopy, camerabottomx, camerabottomy, 0, 0, 0)
###########
#GUI Stuff#
###########
def render_gui():
...
       
        lbc.console_flush()
        print ("cameras: " + str(cameratopx) + " " + str(cameratopy))
        print ("cameratopx + SCREEN_WIDTH/2 VS player.x: " + str(cameratopx + SCREEN_WIDTH/2) + ' ' + str(player.x))
        print ("cameratopy + SCREEN_HEIGHT/2 VS player.y: " + str(cameratopy + SCREEN_HEIGHT/2) + ' ' + str(player.y))
        for Object in objects:
                Object.clear()
       
